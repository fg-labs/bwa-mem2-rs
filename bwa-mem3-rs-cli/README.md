...
Minimal `bwa-rs` CLI wrapping [`bwa-mem3-rs`](https://crates.io/crates/bwa-mem3-rs): aligns paired FASTQ to BGZF-compressed BAM.

## Install

```bash
cargo install bwa-mem3-rs-cli
```
...
- `<ref-prefix>` — a prebuilt bwa-mem3 index (build one with `bwa-mem3 index <ref.fa>`).
...
- [Workspace README](https://github.com/fg-labs/bwa-mem3-rs#readme) — architecture, caveats.
- [`bwa-mem3-rs`](https://crates.io/crates/bwa-mem3-rs) — the library behind this binary.
